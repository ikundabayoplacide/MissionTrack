        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            <div className="hidden md:block">
              <p className="text-sm font-semibold">{user?.fullName || "Finance"}</p>
              <p className="text-xs text-gray-500">{user?.role || "Finance"}</p>
            </div>
          </div>
          ...
          {dropdownOpen && (
            <div className={`absolute right-0 mt-2 w-56 rounded-lg shadow-lg border ${twTheme(
              ...
              <div className="p-4 border-b border-gray-200">
                <p className="font-semibold text-sm">{user?.fullName || "Finance"}</p>
                <p className="text-xs text-gray-500">{user?.email || "finance@example.com"}</p>
